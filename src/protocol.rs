...
use serde_json::{from_str, to_string, to_value, Value, Number};
...
impl Deserialize for StringOrI64 {
    fn deserialize<D>(deserializer: D) -> Result<StringOrI64, D::Error>
        where D: Deserializer
    {
        ...
        impl Visitor for StringOrI64Visitor {
            ...
            fn expecting(&self, formatter: &mut Formatter) -> FmtResult {
                write!(formatter, "a string or i64")
            }
            fn visit_i8<E>(self, value: i8) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_i16<E>(self, value: i16) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_i32<E>(self, value: i32) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_i64<E>(self, value: i64) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                Ok(StringOrI64::I64(value))
            }
            fn visit_u8<E>(self, value: u8) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_u16<E>(self, value: u16) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_u32<E>(self, value: u32) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                self.visit_i64(value as i64)
            }
            fn visit_u64<E>(self, value: u64) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                Ok(StringOrI64::I64(value as i64))
            }
            fn visit_str<E>(self, value: &str) -> Result<StringOrI64, E>
                where E: SerdeError
            {
                Ok(StringOrI64::String(value.into()))
            }
            fn visit_string<E>(self, value: String) -> Result<StringOrI64, E>
                where E: SerdeError
            {
...
impl Serialize for Item {
        ...
        where S: Serializer
    {
        ...
        object.insert("result".to_owned(),
                      Value::Number(Number::from(self.result as i64)));
